...
$rules = [
    ...
    /*
     * Useful for finding methods where you can set the return type as long as
     * you don't do it on extended vendor methods, which is usually only going
     * to be from Laravel. Comment this out once you're done using it.
     */
